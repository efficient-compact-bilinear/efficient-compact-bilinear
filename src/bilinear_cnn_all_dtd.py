...
class BCNN(torch.nn.Module):
    def __init__(self):
        ...
        self.fc = torch.nn.Linear((512//self.d1*self.d2)**2, 57)
        self.norm = runLayer()
...
class BCNNManager(object):
    ...
    def __init__(self, options, path):
        ...
        self._solver = torch.optim.SGD(
            list(self._net.module.fc.parameters()) + list(self._net.module.features.parameters()) + [self._net.module.w1, self._net.module.w2, self._net.module.w3, self._net.module.w4], lr=self._options['base_lr'],
        ...
        imgs_fold = 'data/dtd/images'
        train_ann_file = 'data/dtd/dtd_train.txt'
        valid_ann_file = 'data/dtd/dtd_test.txt'
...
def main():
    ...
    path = {
        'dtd': os.path.join(project_root, 'data/dtd'),
        'model': os.path.join(project_root, 'model_dtd', args.model),
    }
    for d in path:
        if d == 'model':
